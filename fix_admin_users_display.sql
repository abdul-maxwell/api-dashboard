...
-- This will fix the admin dashboard not showing all users
...
-- Step 3: Create a test user to verify the fix works
-- First, let's create a test profile
...
-- Step 4: Create another test user with a real auth user ID (simulated)
-- We'll use a random UUID for testing
INSERT INTO public.profiles (
  user_id,
  email,
  username,
