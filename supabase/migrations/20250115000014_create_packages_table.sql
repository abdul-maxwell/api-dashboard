...
INSERT INTO public.discounts (name, description, promo_code, discount_type, discount_value, min_amount, max_discount, usage_limit, valid_until, created_by) VALUES
('Welcome Discount', '20% off for new users', 'WELCOME20', 'percentage', 20.00, 0, 1000.00, 100, NOW() + INTERVAL '30 days', (SELECT id FROM auth.users WHERE email = 'admin@example.com' LIMIT 1));
