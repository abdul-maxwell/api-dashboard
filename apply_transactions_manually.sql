-- Manual application of transactions table
-- Run this directly in your Supabase SQL editor

-- Create transactions table for tracking all payment operations
...
-- Admins can delete any transactions
