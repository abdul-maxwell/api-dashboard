-- Simple script to create packages and discounts tables
...
-- Admin policies (only admins can modify) - will be created after profiles table exists
-- These policies will be created in a separate step after the profiles table is set up
